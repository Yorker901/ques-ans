...
# Flag to check if the file has been uploaded/processed previously
...
if query and file_processed:  # Ensure that the file was processed before querying
    query_emb = model.encode(query)
    ...
    st.warning("Please upload and process a file before entering a query.")
